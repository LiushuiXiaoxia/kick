...
project(":firebase-analytics").projectDir = file("module/firebase/firebase-analytics")
include(":firebase-analytics-stub")
project(":firebase-analytics-stub").projectDir = file("module/firebase/firebase-analytics-stub")
